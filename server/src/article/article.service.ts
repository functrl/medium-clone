...
export class ArticleService {
    constructor(@InjectRepository(ArticleEntity) private readonly articleRepositiry: Repository<ArticleEntity>) {
    }
    ...
    async findBySlug(slug: string): Promise<ArticleEntity> {
        return await this.articleRepositiry.findOne({slug});
    }
